...
class Admin {
	...
	public function enqueue_scripts( $hook ) {
		...
		// Early core enqueue.
		wc_category_showcase()->scripts->enqueue_style( 'wccshowcase-admin', '/css/admin.css' );
		wc_category_showcase()->scripts->enqueue_script( 'wccshowcase-tabs-controls', '/js/tabs-control.js', array(), true );
		wc_category_showcase()->scripts->enqueue_script( 'wccshowcase-admin', '/js/admin.js', array(), true );
		wc_category_showcase()->scripts->enqueue_style( 'wccshowcase-admin-tailwind', '/css/tailwind.css' );
		wp_localize_script(
			'wccshowcase-admin',
			'wccshowcase_admin_js_vars',
			array(
				'ajax_url'     => admin_url( 'admin-ajax.php' ),
				'search_nonce' => wp_create_nonce( 'wccshowcase_search_category_action' ),
				'i18n'         => array(
	...
	public static function handle_add_category_showcase() {
		check_admin_referer( 'wccshowcase_add_category_showcase' );
	...
	public static function search_categories() {
		check_admin_referer( 'wccshowcase_search_category_action', 'nonce' );
