...
class Feedback extends Component {
	...
	public function register(): void {
		...
		add_action( 'wp_ajax_wc_category_showcase_feedback', array( $this, 'submit_feedback' ) );
	}
	...
	public function render_modal(): void {
		...
		$this->app->template->view(
			...
			array(
				...
				'nonce'    => wp_create_nonce( 'wc_category_showcase_feedback' ),
	...
	public function submit_feedback(): void {
		check_ajax_referer( 'wc_category_showcase_feedback', 'nonce' );
	...
	protected function get_reasons(): array {
		return array(
			'not_working'      => __( 'The plugin is not working', 'wc-category-showcase' ),
			'found_better'     => __( 'I found a better plugin', 'wc-category-showcase' ),
			'no_longer_needed' => __( 'I no longer need the plugin', 'wc-category-showcase' ),
			'temporary'        => __( 'It is a temporary deactivation', 'wc-category-showcase' ),
			'other'            => __( 'Other', 'wc-category-showcase' ),
		);
	}
}
