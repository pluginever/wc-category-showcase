...
$wccshowcase_image_lazy_load         = 'yes';
$wccshowcase_image_zoom_on_hover     = 'yes';
$wccshowcase_interactive_hover_style = 'always_gray';
?>
...
<div class="wcss-settings-row">
	<div class="tw-w-1/3">
		<h3 class="wccshowcase-settings-title"><?php esc_html_e( 'Lazy Load', 'wc-category-showcase' ); ?></h3>
		<p class="wccshowcase-settings-description"><?php esc_html_e( 'Delays the loading of non-essential resources, such as images or scripts, until they are required, improving webpage performance and speed.', 'wc-category-showcase' ); ?></p>
	</div>
	<div class="tw-flex tw-items-center">
		<label class="tw-inline-flex tw-cursor-pointer">
			<input type="checkbox" name="wccshowcase_image_lazy_load" value="<?php echo esc_attr( 'yes' ); ?>" class="tw-sr-only tw-peer" <?php if ( 'yes' === $wccshowcase_image_lazy_load ) { echo 'checked'; } ?>>
...
<div class="wcss-settings-row">
	<div class="tw-w-1/3">
		<h3 class="wccshowcase-settings-title"><?php esc_html_e( 'Zoom on Hover', 'wc-category-showcase' ); ?></h3>
		<p class="wccshowcase-settings-description"><?php esc_html_e( 'Enable the zoom effect to occur when hovering over the images associated with each category.', 'wc-category-showcase' ); ?></p>
	</div>
	<div class="tw-flex tw-items-center">
		<label class="tw-inline-flex tw-cursor-pointer">
			<input type="checkbox" name="wccshowcase_image_zoom_on_hover" value="<?php echo esc_attr( 'yes' ); ?>" class="tw-sr-only tw-peer" <?php if ( 'yes' === $wccshowcase_image_zoom_on_hover ) { echo 'checked'; } ?>>
			<div class="wccshowcase-toggle"></div>
		</label>
	</div>
</div>
<div class="wcss-settings-row">
	<div class="tw-w-1/3">
		<h3 class="wccshowcase-settings-title"><?php esc_html_e( 'Interactive Hover Styles', 'wc-category-showcase' ); ?></h3>
		<p class="wccshowcase-settings-description"><?php esc_html_e( 'Choose from a variety of effects that occur when hovering over the images, adding interactivity and visual appeal.', 'wc-category-showcase' ); ?></p>
	</div>
	<div class="tw-flex tw-items-center">
		<div class="select-wrapper" id="wccshowcase-select-interactive-hover-style">
			<div class="select wccshowcase-sort-order tw-w-[224px] tw-bg-input-grey-50 tw-border-divider-grey-100 tw-rounded-md">
				...
				<div class="custom-options tw-w-[224px] tw-bg-white tw-border-divider-grey-100 tw-rounded-md tw-hidden">
					<span class="custom-option <?php echo 'normal_gray' === $wccshowcase_interactive_hover_style ? 'selected' : ''; ?>" data-value="<?php echo esc_attr( 'normal_gray' ); ?>">
						<?php esc_html_e( 'Grayscale & Normal on Hover', 'wc-category-showcase' ); ?>
					</span>
					<span class="custom-option <?php echo 'only_gray' === $wccshowcase_interactive_hover_style ? 'selected' : ''; ?>" data-value="<?php echo esc_attr( 'only_gray' ); ?>">
						<?php esc_html_e( 'Grayscale Hover', 'wc-category-showcase' ); ?>
					</span>
					<span class="custom-option <?php echo 'always_gray' === $wccshowcase_interactive_hover_style ? 'selected' : ''; ?>" data-value="<?php echo esc_attr( 'always_gray' ); ?>">
						<?php esc_html_e( 'Always Gray Scale', 'wc-category-showcase' ); ?>
					</span>
				</div>
			</div>
			<input type="hidden" name="wccshowcase_interactive_hover_style" id="wccshowcase_interactive_hover_style" value="<?php echo esc_attr( $wccshowcase_interactive_hover_style ); ?>">
		</div>
	</div>
</div>
