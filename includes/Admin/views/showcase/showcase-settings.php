...
<div class="wcc_showcase-settings-row">
	...
	<div class="tw-flex tw-flex-col tw-items-left wcc_showcase-pro">
		<div class="tw-w-[348px] tw-h-[320px] tw-bg-input-grey-50 tw-rounded-md tw-p-2 wcc_showcase-category-list-item tw-opacity-50">
			<div class="tw-mt-3 wcc_showcase-custom-border tw-pb-4">
				...
				<div class="tw-relative tw-flex">
					<input disabled class="wcc_showcase-settings-field-border tw-text-sm tw-w-full !tw-pl-9 tw-h-[36px]" type="text" data-jscolor="{ value: '<?php echo esc_attr( $showcase_details['card']['background_color'] ); ?>', backgroundColor: '#333', shadowColor: '#FFFFFF80', width: 121, height: 121 }" name="wcc_showcase_card[background_color]" value="<?php echo esc_attr( $showcase_details['card']['background_color'] ); ?>">
			...
			<div class="tw-mt-3 wcc_showcase-custom-border tw-pb-4">
				...
				<div class="tw-relative tw-flex">
					<input disabled class="wcc_showcase-settings-field-border tw-text-sm tw-w-full !tw-pl-9 tw-h-[36px]" type="text" data-jscolor="{ value: '<?php echo esc_attr( $showcase_details['card']['text_color'] ); ?>', backgroundColor: '#333', shadowColor: '#FFFFFF84', width: 121, height: 121 }" name="wcc_showcase_card[text_color]" value="<?php echo esc_attr( $showcase_details['card']['text_color'] ); ?>">
					<span class="tw-absolute tw-bg-input-grey-50 tw-py-[8px] tw-px-5 tw-items-center tw-top-[1px] tw-right-[2px] tw-rounded-tr-md tw-rounded-br-md"><?php echo esc_attr( 'HEX' ); ?></span>
				</div>
			</div>
			<div class="tw-mt-3 wcc_showcase-custom-border tw-pb-4">
				...
				<div class="tw-relative tw-flex">
					<input disabled class="wcc_showcase-settings-field-border tw-text-sm tw-w-full !tw-pl-9 tw-h-[36px]" type="text" data-jscolor="{ value: '<?php echo esc_attr( $showcase_details['card']['hover_color'] ); ?>', backgroundColor: '#333', shadowColor: '#FFFFFF83', width: 121, height: 121 }" name="wcc_showcase_card[hover_color]" value="<?php echo esc_attr( $showcase_details['card']['hover_color'] ); ?>">
					<span class="tw-absolute tw-bg-input-grey-50 tw-py-[8px] tw-px-5 tw-items-center tw-top-[1px] tw-right-[2px] tw-rounded-tr-md tw-rounded-br-md"><?php echo esc_attr( 'HEX' ); ?></span>
				</div>
			</div>
			<div class="tw-mt-3 ">
				...
				<div class="tw-relative tw-flex">
					<input disabled class="wcc_showcase-settings-field-border tw-text-sm tw-w-full !tw-pl-9 tw-h-[36px]" type="text" data-jscolor="{ value: '<?php echo esc_attr( $showcase_details['card']['hover_text_color'] ); ?>', backgroundColor: '#333', shadowColor: '#FFFFFF81', width: 121, height: 121 }" name="wcc_showcase_card[hover_text_color]" value="<?php echo esc_attr( $showcase_details['card']['hover_text_color'] ); ?>">
					<span class="tw-absolute tw-bg-input-grey-50 tw-py-[8px] tw-px-5 tw-items-center tw-top-[1px] tw-right-[2px] tw-rounded-tr-md tw-rounded-br-md"><?php echo esc_attr( 'HEX' ); ?></span>
				</div>
			</div>
		</div>
