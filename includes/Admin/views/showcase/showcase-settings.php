...
<div class="wcc_showcase-settings-row">
	...
	<div class="tw-flex tw-items-center <?php echo 'yes' === $showcase_details['wcc_showcase_border_is_all'] ? 'tw-flex-col' : ''; ?>">
		<div class="tw-flex tw-items-center tw-justify-start tw-w-full tw-pb-2">
			...
			<label class="tw-inline-flex tw-cursor-pointer tw-pl-[4px]">
				<input type="number" name="wcc_showcase_border_radius" id="wcc_showcase_border_radius" value="<?php echo esc_attr( $showcase_details['wcc_showcase_border_radius'] ); ?>" class="wcc_showcase-settings-field-border" <?php echo 'yes' === $showcase_details['wcc_showcase_border_is_all'] ? 'disabled' : ''; ?>>
			</label>
			<div class="wcc_showcase-border-is-all tw-pl-[8px] <?php echo 'yes' === $showcase_details['wcc_showcase_border_is_all'] ? 'tw-text-fade-blue-600' : 'tw-text-text-grey-500'; ?>">
				...
				<input type="hidden" value="<?php echo 'yes' === $showcase_details['wcc_showcase_border_is_all'] ? esc_attr( 'yes' ) : ''; ?>" name="wcc_showcase_border_is_all">
			</div>
		</div>
		<div class="tw-mt-3 tw-grid tw-grid-cols-2 tw-gap-y-6 tw-gap-x-3 wcc_showcase-custom-border-top tw-pt-4 wcc_showcase_content_margin_all <?php echo 'yes' === $showcase_details['wcc_showcase_border_is_all'] ? '' : 'tw-hidden'; ?>">
			<div class="tw-flex tw-items-center">
				<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
