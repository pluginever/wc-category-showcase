...
<div class="wcc_showcase-settings-row">
	<div class="tw-w-1/3 sm:tw-w-full">
		<h3 class="wcc_showcase-settings-title"><?php esc_html_e( 'Choose Card Color', 'wc-category-showcase-pro' ); ?></h3>
		<p class="wcc_showcase-settings-description"><?php esc_html_e( 'Customize the color or tint of the category showcase cards to match your store\'s branding or design scheme.', 'wc-category-showcase-pro' ); ?></p>
	</div>
	<div class="tw-flex tw-items-center">
		<div class="tw-w-[348px] tw-h-[320px] tw-bg-input-grey-50 tw-rounded-md tw-p-2 wcc_showcase-category-list-item">
			<div class="tw-mt-3 wcc_showcase-custom-border tw-pb-4">
				<h4 class="tw-my-0 !tw-text-text-grey-500"><?php esc_html_e( 'BG Color', 'wc-category-showcase-pro' ); ?></h4>
			...
			<div class="tw-mt-3 wcc_showcase-custom-border tw-pb-4">
				<h4 class="tw-my-0 !tw-text-text-grey-500"><?php esc_html_e( 'Text Color', 'wc-category-showcase-pro' ); ?></h4>
				<div class="tw-relative tw-flex">
			...
			<div class="tw-mt-3 wcc_showcase-custom-border tw-pb-4">
				<h4 class="tw-my-0 !tw-text-text-grey-500"><?php esc_html_e( 'Hover BG Color', 'wc-category-showcase-pro' ); ?></h4>
				<div class="tw-relative tw-flex">
			...
			<div class="tw-mt-3 ">
				<h4 class="tw-my-0 !tw-text-text-grey-500"><?php esc_html_e( 'Hover Text Color', 'wc-category-showcase-pro' ); ?></h4>
				<div class="tw-relative tw-flex">
