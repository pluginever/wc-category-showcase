...
class Metabox {
	...
	public function __construct() {
		add_action( 'admin_init', array( $this, 'init_featured_cats_settings_metabox' ) );
		add_action( 'admin_init', array( $this, 'init_additional_cats_settings_metabox' ) );

		if ( ! \WC_Category_Showcase::is_pro_installed() ) {
			add_action( 'add_meta_boxes', array( $this, 'init_promotion_metabox' ) );
		}
	}
	...
	public function init_featured_cats_settings_metabox() {
		$metabox = new \WCCategoryShowcase\Framework\Metabox( 'wccs_featured_categories_metabox' );
		$config  = array(
	...
	public function init_additional_cats_settings_metabox() {
		$metabox = new \WCCategoryShowcase\Framework\Metabox( 'wccs_additional_categories_metabox' );
		$config  = array(
	...
	public function promotion_metabox_callback() {
		?>
		<img src="<?php echo WC_CATEGORY_SHOWCASE_ASSETS_URL . '/images/promotion.png'; ?>" alt="WOO Category Showcase Pro" style="width: 100%;margin-bottom: 10px;">
