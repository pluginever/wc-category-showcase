...
* Compatibility - Checked compatibility with the latest version of WordPress (v6.9.3) and WooCommerce (v10.6).

= 2.2.9 (15th February 2026) =
* Fix - Sliders are not properly working issue resolved.

= 2.2.8 (10th February 2026) =
* Fix - Resolved minor issues.
* Compatibility - Checked compatibility with the latest version of WordPress (v6.9) and WooCommerce (v10.4).
...
= 2.0.2 =
* Fix - Resolved some known issues. 
...
* Fix – Compatibility with WP v6.0
* Fix – Compatibility with WC v6.5.1
* Enhance - Additional category link hover background and text color
...
* Fix conflict Smush Image Optimization plugin
