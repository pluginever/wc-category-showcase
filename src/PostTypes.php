...
class PostTypes {
	...
	public function register_cpt() {
		$labels = array(
			...
			'add_new'            => _x( 'Add New', 'Category Showcase', 'wc-category-showcase' ),
			...
			'all_items'          => __( 'All Category Showcase', 'wc-category-showcase' ),
			'search_items'       => __( 'Search Category Showcase', 'wc-category-showcase' ),
			'parent_item_colon'  => __( 'Parent Category Showcase:', 'wc-category-showcase' ),
			'not_found'          => __( 'No category showcase found.', 'wc-category-showcase' ),
			'not_found_in_trash' => __( 'No category showcase found in trash.', 'wc-category-showcase' ),
		);

		$args = array(
			'labels'              => apply_filters( 'wc_start_plugin_category_showcase_post_type_labels', $labels ),
			'public'              => false,
		...
		register_post_type( 'wccs_showcase', apply_filters( 'wc_start_plugin_category_showcase_post_type_args', $args ) );
	}
}
