...
<div class="wcc-showcase-upcoming">
	...
	<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" style="padding: 10px;">
		<div class="b8-card">
			<div class="b8-card__header">
				<h2 class="b8-card__title"><?php echo esc_html__( 'Export Showcases', 'wc-category-showcase' ); ?></h2>
			</div>
	...
	<form action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" method="post" style="padding: 10px;">
		<div class="b8-card">
			<div class="b8-card__header">
				<h2 class="b8-card__title"><?php echo esc_html__( 'Import Showcases', 'wc-category-showcase' ); ?></h2>
			</div>
			<div class="b8-card__body">
				<div class="bk-columns">
					<div class="bk-col-6">
