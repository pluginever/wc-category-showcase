	...
	<div class="tw-p-2 wcc_showcase-category-custom-details tw-hidden">
		...
		<div class="tw-mt-3 tw-flex tw-justify-around wcc_showcase-custom-border tw-pb-4">
			...
			<div>
				...
				<div class="tw-relative tw-mt-2 icon-picker-wrap" id="icon-picker-wrap-<?php echo esc_attr( $category_details['cat_id'] ); ?>">
					<a href="#" class="select-icon wcc_showcase-upload-button wcc_showcase-icon-selection <?php echo 'yes' === $category_details['is_icon'] ? '' : 'tw-hidden'; ?>" id="select-icon-<?php echo esc_attr( $category_details['cat_id'] ); ?>">
					...
					<input class="icon_name" type="hidden" name="wcc_showcase_category_list_item[<?php echo esc_attr( $category_details['cat_id'] ); ?>][icon_name]" value="<?php echo esc_attr( $category_details['icon_name'] ); ?>">
				</div>
